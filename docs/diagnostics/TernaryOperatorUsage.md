...
Использование тернарных операторов затрудняет читаемость кода.
Рекомендуется использовать конструкцию Если-Иначе.

Примеры использования тернарных операторов:
```bsl
