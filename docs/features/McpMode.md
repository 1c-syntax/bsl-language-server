...
- **MCP roots.** Корни, объявленные клиентом через [MCP roots](https://modelcontextprotocol.io/docs/concepts/roots), по-прежнему индексируются автоматически, включая пересинхронизацию по `roots/list_changed`. Это работает, пока сервер собран на MCP SDK ревизии `2025-11-25`, где roots ещё активны.
...
| --- | --- |
| `list_workspaces` | Зарегистрированные рабочие пространства: `root` для остальных инструментов, имя и число проиндексированных файлов |
