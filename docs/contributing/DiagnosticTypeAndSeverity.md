...
Каждая диагностика относится к определенному типу и имеет определенную важность. Для того, чтобы выбрать для создаваемой диагностики, ниже приведено подробное описание.
