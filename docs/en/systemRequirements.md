...
The minimum supported version is Java 11, but as part of the build pipelines, a health check is performed when using more recent versions. На данный момент поддерживаются Java версий 11 и 16.
