...
* [NestedConstructorsInStructureDeclarationDiagnostic - Ограничение на использование конструкторов с параметрами при объявлении структуры](diagnostics/NestedConstructorsInStructureDeclarationDiagnostic.md)
