...
* Обновлены данные синтакс-помощника OneScript до OneScript 2.1; автодополнение видит соседей по
  своему пакету без `#Использовать`; добавлены описания встроенных ключевых слов oscript; классы
  OneScript с аннотацией `&Обходимое` регистрируются как пользовательские коллекции.
