...
@SpringBootTest
class BSLHoverProviderTest {

  @Autowired
  private BSLHoverProvider hoverProvider;
  ...
  void getEmptyHover() {
    ...
    BSLDocumentContext documentContext =(BSLDocumentContext)  TestUtils.getDocumentContextFromFile("./src/test/resources/providers/hover.bsl");
