...
/**
 * Сложный случай extends (комбинирование наследования и интерфейсов):
 * абстрактный родитель объявляет {@code &Реализует("Интерфейс")}, а реализация —
 * в наследнике через {@code &Расширяет}. Переход к реализациям интерфейса должен
 * находить реализующие классы транзитивно по цепочке наследования.
 */
@CleanupContextBeforeClassAndAfterClass
class ImplementationAbstractClassTest extends AbstractServerContextAwareTest {
  ...
  @Test
  void interfaceImplementationsIncludeTransitiveSubclasses() {
    ...
    assertThat(implementations)
      .extracting(ImplementationAbstractClassTest::uriBaseName)
      .containsExactlyInAnyOrder("АбстрактноеХранилище", "КонкретноеХранилище");
  }

  @Test
  void interfaceMethodImplementationsResolveToConcreteSubclass() {
    var interfaceDoc = document("ИнтерфейсХранилища.os");
    ...
    assertThat(implementations)
      .extracting(ImplementationAbstractClassTest::uriBaseName)
      .containsExactly("КонкретноеХранилище");
  }
