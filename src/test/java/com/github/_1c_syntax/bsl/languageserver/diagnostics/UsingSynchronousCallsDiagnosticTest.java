  ...
  void testDontUse() {
    ...
    assertThat(diagnostics)
      ...
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(2, 12, 3, 57))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*Вопрос.*ПоказатьВопрос.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(21, 4, 21, 84))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*Предупреждение.*ПоказатьПредупреждение.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(29, 4, 29, 26))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ОткрытьЗначение.*ПоказатьЗначение.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(43, 9, 43, 58))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ВвестиДату.*ПоказатьВводДаты.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(72, 9, 72, 67))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ВвестиЗначение.*ПоказатьВводЗначения.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(103, 9, 103, 50))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ВвестиСтроку.*ПоказатьВводСтроки.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(122, 9, 122, 61))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ВвестиЧисло.*ПоказатьВводЧисла.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(138, 4, 138, 50))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*УстановитьВнешнююКомпоненту.*НачатьУстановкуВнешнейКомпоненты.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(148, 4, 148, 33))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ОткрытьФормуМодально.*ОткрытьФорму.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(159, 20, 159, 56))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*УстановитьРасширениеРаботыСФайлами.*НачатьУстановкуРасширенияРаботыСФайлами.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(172, 20, 172, 62))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*УстановитьРасширениеРаботыСКриптографией.*НачатьУстановкуРасширенияРаботыСКриптографией.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(184, 12, 184, 54))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ПодключитьРасширениеРаботыСКриптографией.*НачатьПодключениеРасширенияРаботыСКриптографией.*"))
      ...
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(198, 12, 198, 48))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ПодключитьРасширениеРаботыСФайлами.*НачатьПодключениеРасширенияРаботыСФайлами.*"))
      ...
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(214, 4, 214, 88))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ПоместитьФайл.*НачатьПомещениеФайла.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(225, 4, 225, 68))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*КопироватьФайл.*НачатьКопированиеФайла.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(236, 4, 236, 69))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ПереместитьФайл.*НачатьПеремещениеФайла.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(247, 21, 247, 51))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*НайтиФайлы.*НачатьПоискФайлов.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(260, 8, 260, 37))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*УдалитьФайлы.*НачатьУдалениеФайлов.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(274, 4, 274, 29))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*СоздатьКаталог.*НачатьСозданиеКаталога.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(285, 16, 285, 40))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*КаталогВременныхФайлов.*НачатьПолучениеКаталогаВременныхФайлов.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(296, 16, 296, 35))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*КаталогДокументов.*НачатьПолучениеКаталогаДокументов.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(307, 16, 307, 50))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*РабочийКаталогДанныхПользователя.*НачатьПолучениеРабочегоКаталогаДанныхПользователя.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(318, 16, 318, 89))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ПолучитьФайлы.*НачатьПолучениеФайлов.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(344, 16, 344, 64))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ПоместитьФайлы.*НачатьПомещениеФайлов.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(368, 12, 368, 59))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ЗапроситьРазрешениеПользователя.*НачатьЗапросРазрешенияПользователя.*"))
      .anyMatch(diagnostic -> diagnostic.getRange().equals(Ranges.create(391, 4, 391, 38))
        && diagnostic.getMessage().getLeft().matches(".*(синхронного|synchronous).*ЗапуститьПриложение.*НачатьЗапускПриложения.*"));
  }
