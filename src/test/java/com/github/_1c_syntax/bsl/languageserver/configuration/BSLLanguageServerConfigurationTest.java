...
class BSLLanguageServerConfigurationTest {
  ...
  void test_GetCustomConfigurationRoot() {
    ...
    Path configurationRoot = BSLLanguageServerConfiguration.getCustomConfigurationRoot(configuration, path);
    assertThat(configurationRoot).isEqualTo(Absolute.path(path));

    File configurationFile = new File(PATH_TO_CONFIGURATION_FILE);
    configuration.update(configurationFile);
    configurationRoot = BSLLanguageServerConfiguration.getCustomConfigurationRoot(configuration, path);
    assertThat(configurationRoot).isEqualTo(Absolute.path(path));
