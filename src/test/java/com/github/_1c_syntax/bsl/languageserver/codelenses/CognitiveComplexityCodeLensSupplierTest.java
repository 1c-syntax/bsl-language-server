...
class CognitiveComplexityCodeLensSupplierTest {

  private final static String FILE_PATH = "./src/test/resources/codelenses/CognitiveComplexityCodeLensSupplier.bsl";
