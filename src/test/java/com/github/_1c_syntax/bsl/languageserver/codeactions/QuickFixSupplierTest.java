...
class QuickFixSupplierTest {
  ...
  void testGetQuickFixClass() {
    ...
    Optional<Class<? extends QuickFixProvider>> quickFixClass =
      quickFixSupplier.getQuickFixClass(Either.forLeft("NON_EXISTING"));
    assertThat(quickFixClass).isEmpty();

    quickFixClass = quickFixSupplier.getQuickFixClass(Either.forLeft("CommitTransactionOutsideTryCatch"));
    assertThat(quickFixClass).isEmpty();

    quickFixClass = quickFixSupplier.getQuickFixClass(Either.forLeft("CommentedCode"));
