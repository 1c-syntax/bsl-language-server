...
class UnknownPreprocessorSymbolDiagnosticTest extends AbstractDiagnosticTest<UnknownPreprocessorSymbolDiagnostic> {
  ...
  UnknownPreprocessorSymbolDiagnosticTest() {
    super(UnknownPreprocessorSymbolDiagnostic.class);
  }
  ...
  void test() {
    ...
    assertThat(diagnostics.get(1).getRange()).isEqualTo(RangeHelper.newRange(4, 6, 4, 7));
  }
}
