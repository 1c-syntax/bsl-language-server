...
// Примеры с вложенными аннотациями
&ТестоваяАннотация(&ВложеннаяАннотация("Значение"))
Перем ПеременнаяСВложеннойАннотацией;

&ТестоваяАннотация(Параметр = &ВложеннаяАннотация("Значение"))
Перем ПеременнаяСИменованнойВложеннойАннотацией;

&ТестоваяАннотация(&ВложеннаяАннотация(&ГлубокоВложеннаяАннотация("Глубокое значение")))
Перем ПеременнаяСГлубокоВложеннойАннотацией;
