...
/**
 * Расширения протокола LSP уровня документа (textDocument).
 * <p>
 * Содержит дополнительные методы JSON-RPC {@code textDocument/*}, не входящие в стандартную
 * спецификацию LSP.
 */
public interface TextDocumentProtocolExtension {
