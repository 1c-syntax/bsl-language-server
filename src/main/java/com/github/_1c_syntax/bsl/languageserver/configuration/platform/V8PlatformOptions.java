...
public class V8PlatformOptions {
  ...
  /**
   * Целевая версия платформы 1С для диагностик совместимости (устаревание,
   * недоступность члена по версии). Имеет приоритет над режимом совместимости
   * конфигурации: если задана, сравнение версий ведётся относительно неё.
   * Если не задана — используется режим совместимости конфигурации, а при его
   * отсутствии считается, что используется самая свежая платформа.
   * <p>
   * Формат: {@code 8.3.21}.
   */
