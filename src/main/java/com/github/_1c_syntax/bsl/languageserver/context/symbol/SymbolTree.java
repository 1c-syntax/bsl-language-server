...
public class SymbolTree {
  ...
  public Optional<VariableSymbol> getVariableSymbol(ParserRuleContext ctx) {
    ...
    var variableName = varNameNode.getText();
    var position = Ranges.create(varNameNode).getStart();
    var scope = getSymbolAtPosition(position);

    return getVariableSymbol(variableName, scope);
  }
