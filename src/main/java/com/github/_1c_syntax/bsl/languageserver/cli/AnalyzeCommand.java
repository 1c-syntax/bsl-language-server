 ...
 *  -w, (--workspaceDir) &lt;arg&gt; -  Путь к каталогу проекта относительно котого указыватся пути к исходным файлам.
 *                                Возможно указывать как в абсолютном, так и относительном виде. Если параметр опущен,
 *                                то пути к исходным файлам будут показыватья относительно текущего каталога запуска.
