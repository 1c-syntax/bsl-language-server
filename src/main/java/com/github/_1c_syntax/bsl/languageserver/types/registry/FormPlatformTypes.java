...
final class FormPlatformTypes {
   ...
   * который платформа объявила у одноимённого свойства поля ввода.
   * <p>
  ...
  static final Map<String, Map<String, String>> TYPELESS_MEMBER_TYPES = Map.of(
    ...
    FORM_BUTTON, Map.of(
      SERVER_UNAVAILABLE_BEHAVIOR, SERVER_UNAVAILABLE_BEHAVIOR,
      // «Если свойство установлено в Истина, то кнопка отображается как "Нажатая"».
      "Пометка", BOOLEAN_RU),
    FORM_DECORATION, Map.of(
      SERVER_UNAVAILABLE_BEHAVIOR, SERVER_UNAVAILABLE_BEHAVIOR),
    FORM_TABLE, Map.of(
      SERVER_UNAVAILABLE_BEHAVIOR, SERVER_UNAVAILABLE_BEHAVIOR,
      // «Если нет ни одной строки — ставит ОтметкаНезаполненного в Истина, иначе Ложь»;
      // у одноимённого свойства поля ввода платформа объявляет Булево.
    ...
    TABLE_EXTENSION_PREFIX + "динамического списка", Map.of(
      // «Признак необходимости сохранения и восстановления текущей позиции в списке».
