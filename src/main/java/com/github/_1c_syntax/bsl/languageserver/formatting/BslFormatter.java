...
/**
 * Движок форматирования кода BSL: превращает поток токенов в отформатированный текст согласно
 * протокольным {@link FormattingOptions} и настройкам форматирования рабочей области.
 */
@Component
