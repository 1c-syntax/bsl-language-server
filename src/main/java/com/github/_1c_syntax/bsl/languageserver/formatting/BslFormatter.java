...
/**
 * Движок форматирования кода BSL: превращает поток токенов в отформатированный текст.
 * <p>
 * Выделен из {@code FormatProvider}, чтобы провайдер остался тонким LSP-адаптером, а сам алгоритм
 * форматирования был переиспользуемой подсистемой (его применяют и провайдер форматирования, и
 * диагностики для нормализации текста).
 */
@Component
