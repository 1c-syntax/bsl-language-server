...
public class PlatformMemberVersions {
  ...
  /**
   * Сущность (член, тип, конструктор) устарела для целевой платформы —
   * по своим метаданным. Какое поле отвечает за устаревание, знает этот
   * метод, а не вызывающая сторона.
   */
