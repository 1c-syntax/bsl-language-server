...
public class FoldingRangeLsifSupplier implements LsifDataSupplier {
  ...
  public void supply(DocumentContext documentContext, long documentId, LsifEmitter emitter) {
    ...
    // Emit foldingRangeResult vertex
    var foldingRangeResultId = emitter.emitFoldingRangeResult(foldingRanges);

    // Link document to foldingRangeResult
    emitter.emitFoldingRangeEdge(documentId, foldingRangeResultId);
  }
}
