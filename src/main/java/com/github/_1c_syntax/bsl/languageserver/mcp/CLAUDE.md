...
> Примечание: в `package-info.java` режим всё ещё назван «прототипом» — формулировка устарела
> (транспорты stdio/SSE/Streamable HTTP рабочие). Стоит обновить package-info.
