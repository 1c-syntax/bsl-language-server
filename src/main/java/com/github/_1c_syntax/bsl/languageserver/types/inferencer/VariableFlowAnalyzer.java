...
public class VariableFlowAnalyzer extends AbstractDocumentLifecycleClearableIndex {
  ...
  public interface GuardNarrowing {
    ...
    /**
     * Как условие сужает тип переменной внутри самого себя — по проверкам левее точки.
     * <p>
     * В конъюнкции до правой части доходят только когда левая истинна, поэтому обращение в
     * правой части видит переменную уже суженной.
     *
     * @param variable  переменная, тип которой сужается.
     * @param condition выражение условия.
  ...
  /**
   * Тип, суженный проверками внутри самого условия — теми, что стоят левее точки обращения.
   * <p>
   * Сужение по ветвям применяется к рёбрам, то есть к коду за условием. Но и внутри условия
   * порядок значим: в конъюнкции до правой части доходят только когда левая истинна.
   *
   ...
   * @param inputs       исходные данные расчёта.
   * @return суженный тип; исходный, если оператор не условие либо левее точки про переменную
